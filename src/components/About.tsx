...
const About = () => {
  ...
  return (
    <section id="about" className="py-24 relative overflow-hidden" style={{ backgroundColor: 'hsl(var(--section-medium))' }}>
      ...
      <div className="absolute top-1/3 right-1/3 w-6 h-6 bg-accent rounded-full animate-float-diagonal shadow-[0_0_25px_currentColor] blur-[1px]" style={{ opacity: 0.8 }} />
      <div className="absolute bottom-1/4 right-1/4 w-7 h-7 bg-[hsl(180,70%,55%)] rounded-full animate-float-zigzag shadow-[0_0_28px_currentColor] blur-[1px]" style={{ opacity: 0.75 }} />
